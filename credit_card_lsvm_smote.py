...
# Inicializácia modelu LinearSVC
...
for train, test in sss.split(original_Xtrain, original_ytrain):
    ...
    prediction = svm_classifier.predict(original_Xtrain[test])

    accuracy_lst.append(svm_classifier.score(original_Xtrain[test], original_ytrain[test]))
...
#     X_train_fold, y_train_fold = smote.fit_resample(original_Xtrain[train], original_ytrain[train])
#     svm_classifier.fit(X_train_fold, y_train_fold)
#     decision_values = svm_classifier.decision_function(original_Xtrain[test])
#     prediction = (decision_values > 0)  # nastavte vhodný prah na rozhodnutie
#
#     accuracy_lst.append(svm_classifier.score(original_Xtrain[test], original_ytrain[test]))
#     precision_lst.append(precision_score(original_ytrain[test], prediction))
#     recall_lst.append(recall_score(original_ytrain[test], prediction))
...
smote_prediction = svm_classifier.predict(original_Xtest)
print(classification_report(original_ytest, smote_prediction, target_names=labels))

# # y_score = svm_classifier.predict_proba(original_Xtest)[:, 1]
