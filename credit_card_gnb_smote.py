...
# Inicializácia modelu GaussianNB
...
for train, test in sss.split(original_Xtrain, original_ytrain):
    ...
    prediction = gnb_classifier.predict(original_Xtrain[test])

    accuracy_lst.append(gnb_classifier.score(original_Xtrain[test], original_ytrain[test]))
...
smote_prediction = gnb_classifier.predict(original_Xtest)
print(classification_report(original_ytest, smote_prediction, target_names=labels))

y_score = gnb_classifier.predict_proba(original_Xtest)[:, 1]
