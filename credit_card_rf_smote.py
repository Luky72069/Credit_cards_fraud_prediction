...
from sklearn.metrics import recall_score, auc, precision_recall_curve, precision_score, roc_auc_score, \
...
# Inicializácia modelu RandomForestClassifier
...
for train, test in sss.split(original_Xtrain, original_ytrain):
    ...
    prediction = rf_classifier.predict(original_Xtrain[test])

    accuracy_lst.append(rf_classifier.score(original_Xtrain[test], original_ytrain[test]))
...
smote_prediction = rf_classifier.predict(original_Xtest)
print(classification_report(original_ytest, smote_prediction, target_names=labels))

y_score = rf_classifier.predict_proba(original_Xtest)[:, 1]
