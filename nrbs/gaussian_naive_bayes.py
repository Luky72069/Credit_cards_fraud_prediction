...
print("Gaussian Naive Bayes AC score: ",round(metrics.accuracy_score(prediction1, y_test), 4))

f1_gnb = f1_score(y_test, prediction1, average='weighted')
print("Gaussian Naive Bayes F1 score:", round(f1_gnb, 4))

recall_gnb = recall_score(y_test, prediction1, average='weighted')
print("Gaussian Naive Bayes Recall score:", round(recall_gnb, 4))

precision_gnb = precision_score(y_test, prediction1)
