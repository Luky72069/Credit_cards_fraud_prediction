...
print("Decision Tree AC score: ",round(metrics.accuracy_score(prediction1, y_test), 4))

f1_dt = f1_score(y_test, prediction1, average='weighted')
print("Decision Tree F1 score:", round(f1_dt, 4))

recall_dt = recall_score(y_test, prediction1, average='weighted')
print("Decision Tree Recall score:", round(recall_dt, 4))

precision_dt = precision_score(y_test, prediction1)
